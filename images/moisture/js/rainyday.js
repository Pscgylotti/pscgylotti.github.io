...
RainyDay.prototype.checkSize = function() {
    ...
    (e !== a || f !== b) && (this.canvas.width = this.canvas.width,
    this.canvas.height = this.canvas.height,
    this.prepareBackground(this.canvas.width, this.canvas.height),
    this.glass.width = this.canvas.width,
    this.glass.height = this.canvas.height,
    this.prepareReflections()),
    (g !== c || h !== d) && (this.canvas.offsetLeft = c,
    this.canvas.offsetTop = d)
}
,
...
,
RainyDay.prototype.setAngle = function(x){
    this.options.gravityAngle = x;
...
Drop.prototype.clear = function(a) {
    ...
    a ? (this.terminate = !0,
    !0) : this.y - this.r > this.rainyday.h || this.x - this.r > this.rainyday.w || this.x + this.r < 0 ? !0 : !1
}
,
...
RainyDay.prototype.TRAIL_DROPS = function(a) {
    ...
    this.putDrop(new Drop(this,a.x + (2 * Math.random() - 1) * Math.random(),a.y - a.r - 5,Math.ceil(a.r / 5),0)))
}
,
...
RainyDay.prototype.GRAVITY_NON_LINEAR = function(a) {
    return this.clearDrop(a) ? !0 : (a.collided ? (a.collided = !1,
